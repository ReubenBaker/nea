...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MoveConcertFromTicketToBooking
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MoveConcertFromTicketToBooking))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201804172102477_MoveConcertFromTicketToBooking"
            End Get
        End Property
