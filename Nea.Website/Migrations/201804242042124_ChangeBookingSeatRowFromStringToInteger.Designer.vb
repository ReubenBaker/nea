...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ChangeBookingSeatRowFromStringToInteger
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ChangeBookingSeatRowFromStringToInteger))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201804242042124_ChangeBookingSeatRowFromStringToInteger"
            End Get
        End Property
