...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RemoveTicket
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemoveTicket))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201804182035084_RemoveTicket"
            End Get
        End Property
