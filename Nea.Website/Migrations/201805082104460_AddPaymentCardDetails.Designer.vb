...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddPaymentCardDetails
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddPaymentCardDetails))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201805082104460_AddPaymentCardDetails"
            End Get
        End Property
